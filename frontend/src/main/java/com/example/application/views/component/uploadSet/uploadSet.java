package com.example.application.views.component.uploadSet;
 ...
 */
public class uploadSet extends UploadI18N {
    public uploadSet() {
        setDropFiles(new DropFiles().setOne("Drop image here")
                .setMany("Drop image here"));
        setAddFiles(new AddFiles().setOne("Upload Image...")
                .setMany("Upload Images..."));
